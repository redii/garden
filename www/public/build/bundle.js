    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span1 = element("span");
    			span1.textContent = "»";
    			add_location(h2, file$1, 43, 12, 1135);
    			add_location(p, file$1, 44, 12, 1172);
    			...
    			add_location(img, file$1, 53, 12, 1489);
    			attr_dev(div0, "class", "col-lg-6 mb-5");
    			add_location(div0, file$1, 42, 8, 1095);
    			attr_dev(th0, "scope", "col");
    			add_location(th0, file$1, 63, 24, 1789);
    			attr_dev(th1, "scope", "col");
    			add_location(th1, file$1, 64, 24, 1836);
    			attr_dev(th2, "scope", "col");
    			add_location(th2, file$1, 65, 24, 1891);
    			add_location(tr, file$1, 62, 20, 1760);
    			add_location(thead, file$1, 61, 16, 1732);
    			add_location(tbody, file$1, 68, 16, 1985);
    			attr_dev(table, "class", "table svelte-pafhem");
    			add_location(table, file$1, 60, 12, 1694);
    			attr_dev(span0, "aria-hidden", "true");
    			add_location(span0, file$1, 106, 28, 3617);
    			attr_dev(button0, "class", "page-link");
    			attr_dev(button0, "href", "#");
    			attr_dev(button0, "aria-label", "Previous");
    			add_location(button0, file$1, 100, 24, 3347);
    			attr_dev(li0, "class", "page-item");
    			add_location(li0, file$1, 99, 20, 3300);
    			...
    			add_location(input, file$1, 110, 24, 3784);
    			attr_dev(li1, "class", "page-item");
    			add_location(li1, file$1, 109, 20, 3737);
    			attr_dev(span1, "aria-hidden", "true");
    			add_location(span1, file$1, 126, 28, 4470);
    			attr_dev(button1, "class", "page-link");
    			attr_dev(button1, "href", "#");
    			attr_dev(button1, "aria-label", "Next");
    			add_location(button1, file$1, 120, 24, 4204);
    			attr_dev(li2, "class", "page-item");
    			add_location(li2, file$1, 119, 20, 4157);
    			attr_dev(ul, "class", "pagination");
    			add_location(ul, file$1, 98, 16, 3256);
    			add_location(nav, file$1, 97, 12, 3234);
    			attr_dev(div1, "class", "col-lg-6");
    			add_location(div1, file$1, 59, 8, 1659);
    			attr_dev(div2, "class", "row");
    			add_location(div2, file$1, 41, 4, 1069);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 37, 12, 997);
    			attr_dev(div0, "class", "col");
    			add_location(div0, file$1, 36, 8, 967);
    			attr_dev(div1, "class", "row");
    			add_location(div1, file$1, 35, 4, 941);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(th, file$1, 71, 28, 2097);
    			add_location(td0, file$1, 72, 28, 2157);
    			...
    			add_location(a, file$1, 85, 32, 2783);
    			add_location(td1, file$1, 84, 28, 2746);
    			add_location(tr, file$1, 70, 24, 2064);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(70:20) {#each tableData as image}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			p1 = element("p");
    			p1.textContent = "But since my garding skills and reliability when it comes to plants\n            are about 0, I had to automate that process.";
    			t8 = space();
    			p2 = element("p");
    			t9 = text("Read more about my garden project on\n            ");
    			a1 = element("a");
    			...
    			attr_dev(img, "alt", "Garden Logo");
    			attr_dev(img, "class", "garden-logo svelte-pafhem");
    			add_location(img, file$1, 15, 8, 295);
    			attr_dev(div0, "class", "col-md-3 text-center");
    			add_location(div0, file$1, 14, 4, 252);
    			add_location(h1, file$1, 18, 8, 411);
    			attr_dev(a0, "href", "https://redd.it/vkuhvk");
    			add_location(a0, file$1, 20, 16, 461);
    			add_location(p0, file$1, 19, 8, 441);
    			add_location(p1, file$1, 23, 8, 579);
    			attr_dev(a1, "href", "https://github.com/redii/garden");
    			add_location(a1, file$1, 29, 12, 806);
    			add_location(p2, file$1, 27, 8, 741);
    			attr_dev(div1, "class", "col-md-9");
    			add_location(div1, file$1, 17, 4, 380);
    			attr_dev(div2, "class", "row");
    			add_location(div2, file$1, 13, 0, 230);
    			attr_dev(hr, "class", "mt-5 mb-5");
    			add_location(hr, file$1, 33, 0, 891);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span = element("span");
    			span.textContent = "❤️";
    			if (!src_url_equal(img.src, img_src_value = "./assets/github.jpeg")) attr_dev(img, "src", img_src_value);
